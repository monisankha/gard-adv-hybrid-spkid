...
def main(args):
    ...
    args.attack_method = attack_list[2]
...
def parse_args():
    ...
    parser.add_argument('--model_dir', default='/data/monisankha/darpa_gard/gard-adversarial-audio/model_pgd_moni2/', type=str, help='model path')
